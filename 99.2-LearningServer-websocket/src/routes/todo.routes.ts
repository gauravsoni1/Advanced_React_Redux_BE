...
export class TodoRoutes {
  ...
  public get routes() {
    ...
    this.router.get('/list/longpoll', todoController.getTodoListLongPoll.bind(todoController));
    this.router.get('/list/sse', todoController.getTodoListSSE.bind(todoController));
